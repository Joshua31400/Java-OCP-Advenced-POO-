...
public class MainOCP {
    ...
    public static void main(String[] args) {
        ...
        while (!quitter) {
            ...
            System.out.println("Montant après remise (" + client.getNom() + ") : " + total);
        }
    ...
    private static Client creerClient(int choix) {
        switch (choix) {
            case 1: return new ClientStandard();
            case 2: return new ClientEtudiant();
            case 3: return new ClientVIP();
            default: return null;
        }
    }
